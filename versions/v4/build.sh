...
set -e
cd "$(dirname "$0")"
PARTS="src/00-head.html src/01-shell.html src/10-data.js src/11-data-ops.js src/20-lib.js src/30-member.js src/40-admin.js src/41-admin2.js src/50-super.js src/60-handoff.js src/65-journey.js src/66-runs.js src/67-schedules.js src/68-share.js src/69-spend.js src/70-app.js"
mkdir -p dist
