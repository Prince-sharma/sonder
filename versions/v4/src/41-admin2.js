...
WhatsApp is now a source if you connect it, so a deal you followed up on WhatsApp won't get flagged as cold.</textarea>
  ...
  <aside class="stack g16">
    ...
    <section class="panel"><div class="panel-h"><h3>What it will cost</h3>
      <div class="r"><span class="chip plain mono">before you publish</span></div></div>
      <div class="panel-b stack g12">
        <div class="rowflex"><span class="tiny faint">Projected runs / month</span><span class="topbar-spacer"></span><b class="mono">365</b></div>
        <div class="rowflex"><span class="tiny faint">Band</span><span class="topbar-spacer"></span><b class="mono">Standard · 3</b></div>
        <div class="rowflex"><span class="tiny faint">Projected units</span><span class="topbar-spacer"></span><b class="mono">1,095</b></div>
        <div class="field" style="margin-top:4px"><label>Budget cap for this agent</label>
          <div class="rowflex" style="gap:7px"><input class="inp" id="pub-cap" value="1,500">
            <span class="chip ok">${ICON.check}37% headroom</span></div>
          <span class="hint">Defaulted from the projection above. Crossing it pauses this agent's schedules — never anyone's typing — and tells you and Ananya with the number and the cause.</span></div>
        <div class="callout tiny"><b>Adding WhatsApp adds about 40 runs a month</b> for the four people who connect it. Included above.</div>
      </div></section>

    <section class="panel"><div class="panel-h"><h3>If this goes wrong</h3></div>
      <div class="panel-b stack g12">
        <div class="rowflex"><span class="tiny faint">Rollback target</span><span class="topbar-spacer"></span><b class="mono">v4.1</b></div>
        <div class="rowflex"><span class="tiny faint">Installs to move</span><span class="topbar-spacer"></span><b class="mono">12</b></div>
        <div class="rowflex"><span class="tiny faint">Settings preserved</span><span class="topbar-spacer"></span><b class="mono">All</b></div>
        <button class="btn sm" data-act="rollback" style="width:100%;justify-content:center">Roll back to v4.1</button>
        <span class="tiny faint">v4.0 was rolled back after four hours in September. A publish gate with no undo behind it is half a control — the competitor ships evaluations with no deploy or rollback endpoint at all, so a regression can be detected and nothing can act on it.</span>
      </div></section>
  </aside></div></div>`;
