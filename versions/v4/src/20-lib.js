...
const state={role:"super", route:"", notes:false, installed:new Set(INSTALLED), approved:new Set(),
             ...
             /* v4 operational layer — see src/11-data-ops.js and 66–69 */
             runFilter:"all", answered:new Set(), backfill:false, dryRun:false,
             nudgeDone:new Set(), trigNL:"Every weekday at 8:15"};
...
const ICON={
 ...
 list:'<svg width="15" height="15" viewBox="0 0 16 16" fill="none"><path d="M5.6 4.2h8M5.6 8h8M5.6 11.8h8" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/><circle cx="2.9" cy="4.2" r="1" fill="currentColor"/><circle cx="2.9" cy="8" r="1" fill="currentColor"/><circle cx="2.9" cy="11.8" r="1" fill="currentColor"/></svg>',
 clocknav:'<svg width="15" height="15" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="6.2" stroke="currentColor" stroke-width="1.35"/><path d="M8 4.4V8l2.6 1.7" stroke="currentColor" stroke-width="1.45" stroke-linecap="round"/></svg>',
 alertnav:'<svg width="15" height="15" viewBox="0 0 16 16" fill="none"><path d="M8 2 14.9 13.8H1.1L8 2Z" stroke="currentColor" stroke-width="1.35" stroke-linejoin="round"/><path d="M8 6.5v3.2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><circle cx="8" cy="11.6" r=".9" fill="currentColor"/></svg>',
 plusnav:'<svg width="15" height="15" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="6.2" stroke="currentColor" stroke-width="1.35"/><path d="M8 5.2v5.6M5.2 8h5.6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
 share:'<svg width="15" height="15" viewBox="0 0 16 16" fill="none"><circle cx="12.2" cy="3.9" r="2.1" stroke="currentColor" stroke-width="1.35"/><circle cx="3.8" cy="8" r="2.1" stroke="currentColor" stroke-width="1.35"/><circle cx="12.2" cy="12.1" r="2.1" stroke="currentColor" stroke-width="1.35"/><path d="m5.7 7 4.6-2.2M5.7 9l4.6 2.2" stroke="currentColor" stroke-width="1.35" stroke-linecap="round"/></svg>',
 coin:'<svg width="15" height="15" viewBox="0 0 16 16" fill="none"><ellipse cx="8" cy="4.4" rx="5.4" ry="2.2" stroke="currentColor" stroke-width="1.35"/><path d="M2.6 4.4v7.2c0 1.2 2.4 2.2 5.4 2.2s5.4-1 5.4-2.2V4.4M2.6 8c0 1.2 2.4 2.2 5.4 2.2s5.4-1 5.4-2.2" stroke="currentColor" stroke-width="1.35"/></svg>',
